            ...
            <!-- Brand and toggle get grouped for better mobile display -->
             ...
             <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <li>
                     ...
                     <li>
                         <a href="conta.php"><i class="fa fa-money fa-1x"></i> DESPESAS</a>
                    </li>
                    <li>
                         <a href="relatorio.php"><i class="fa fa-pie-chart fa-1x"></i> RELATÓRIO</a>
                    </li>
                    <li>
                         <a href="listarUsuario.php"><i class="fa fa-users fa-1x"></i> USUÀRIOS</a>
                    </li>
                    <li>
                         <a href="listarLogs.php"><i class="fa fa-bar-chart fa-1x"></i> LOGS</a>
                    </li>
                    </ul>                          
